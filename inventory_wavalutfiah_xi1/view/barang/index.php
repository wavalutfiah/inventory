...
<tr>
  ...
  <td>
        <a href= "view_edit.php?id_barang=<?php echo $result['id_barang']?>" class="btn btn-primary" ><i class="fa-solid fa-pen-to-square"></i>edit</a>
        <a href = "hapus.php?id_barang=<?php echo $result['id_barang']?>" class="btn btn-secondary"><i class="fa-solid fa-delete-left"></i>hapus </a>
        </td>
    </tr>
    <?php 
    $no++;
